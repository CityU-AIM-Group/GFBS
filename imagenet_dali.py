...
if __name__ == '__main__':
    train_loader = get_imagenet_iter_dali(type='val', image_dir='/home/liuxinyu/content/datasets/natural/ImageNet_in_folder_resized', batch_size=256,
    ...
    train_loader = get_imagenet_iter_torch(type='val', image_dir='/home/liuxinyu/content/datasets/natural/ImageNet_in_folder_resized', batch_size=256,
                                           num_threads=4, crop=224, device_id=0, num_gpus=1)
    print('start iterate')
    start = time.time()
    for i, data in enumerate(train_loader):
